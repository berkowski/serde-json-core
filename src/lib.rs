...
#[doc(inline)]
pub use self::ser::{to_slice, to_slice_pretty, to_slice_with_format};
#[cfg(feature = "heapless")]
pub use self::ser::{to_string, to_vec, to_vec_pretty, to_string_pretty, to_vec_with_format, to_string_with_format};
